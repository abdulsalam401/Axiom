...
<header>
  ...
  <div class="meta">
    ...
    <div>Author: Abdul Salam | Salamcs.app</div>
  </div>
</header>
<main>
...
<footer>
  <p>Axiom &copy; 2026 | Author: <a href="https://salamcs.app">Abdul Salam</a> | For authorized use only</p>
</footer>
</body>
</html>
"""
...
def generate_html_report(data: dict, output: str = "axiom_report.html") -> str:
...
def generate_json_report(data: dict, output: str = "axiom_report.json") -> str:
